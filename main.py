...
def signal_handler(sig, frame):
    ...
    with open('players.json', 'w') as file:
        json.dump(Runner.global_data.players, file)
    """
    with open('server.json', 'w') as file:
        json.dump(Runner.global_data.servers, file)
    sys.exit(0)
...
try:
    bot.run("MTIyNTIyMjg4MjE0NjM4NjAzMw.Gbdi40.1eNH-UomgB7NtKPJNWGLWoFonzlr9MdscBCNaI")
